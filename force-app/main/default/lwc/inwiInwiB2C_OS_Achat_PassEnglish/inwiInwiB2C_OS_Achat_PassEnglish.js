...
import { OMNIDEF } from './inwiInwiB2C_OS_Achat_PassEnglish_def.js';
import tmpl from './inwiInwiB2C_OS_Achat_PassEnglish.html';
import tmpl_nds from './inwiInwiB2C_OS_Achat_PassEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwiInwiB2C_OS_Achat_PassEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
