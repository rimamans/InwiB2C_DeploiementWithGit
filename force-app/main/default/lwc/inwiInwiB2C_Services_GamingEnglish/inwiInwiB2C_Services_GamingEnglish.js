...
import { OMNIDEF } from './inwiInwiB2C_Services_GamingEnglish_def.js';
import tmpl from './inwiInwiB2C_Services_GamingEnglish.html';
import tmpl_nds from './inwiInwiB2C_Services_GamingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwiInwiB2C_Services_GamingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
