...
import { OMNIDEF } from './inwib2cMigrationPrepayeCampusConnecteEnglish_def.js';
import tmpl from './inwib2cMigrationPrepayeCampusConnecteEnglish.html';
import tmpl_nds from './inwib2cMigrationPrepayeCampusConnecteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationPrepayeCampusConnecteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
