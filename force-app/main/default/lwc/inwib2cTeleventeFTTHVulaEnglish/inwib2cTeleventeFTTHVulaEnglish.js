...
import { OMNIDEF } from './inwib2cTeleventeFTTHVulaEnglish_def.js';
import tmpl from './inwib2cTeleventeFTTHVulaEnglish.html';
import tmpl_nds from './inwib2cTeleventeFTTHVulaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTeleventeFTTHVulaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
