...
import { OMNIDEF } from './inwib2cInwiB2C_prolongValidityEnglish_def.js';
import tmpl from './inwib2cInwiB2C_prolongValidityEnglish.html';
import tmpl_nds from './inwib2cInwiB2C_prolongValidityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_prolongValidityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
