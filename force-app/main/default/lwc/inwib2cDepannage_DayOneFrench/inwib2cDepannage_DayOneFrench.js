...
import { OMNIDEF } from './inwib2cDepannage_DayOneFrench_def.js';
import tmpl from './inwib2cDepannage_DayOneFrench.html';
import tmpl_nds from './inwib2cDepannage_DayOneFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cDepannage_DayOneFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
