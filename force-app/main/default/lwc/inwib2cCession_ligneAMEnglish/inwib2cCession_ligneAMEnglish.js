...
import { OMNIDEF } from './inwib2cCession_ligneAMEnglish_def.js';
import tmpl from './inwib2cCession_ligneAMEnglish.html';
import tmpl_nds from './inwib2cCession_ligneAMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCession_ligneAMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
