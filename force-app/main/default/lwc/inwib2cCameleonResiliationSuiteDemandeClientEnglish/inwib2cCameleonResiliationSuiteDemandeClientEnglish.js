...
import { OMNIDEF } from './inwib2cCameleonResiliationSuiteDemandeClientEnglish_def.js';
import tmpl from './inwib2cCameleonResiliationSuiteDemandeClientEnglish.html';
import tmpl_nds from './inwib2cCameleonResiliationSuiteDemandeClientEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCameleonResiliationSuiteDemandeClientEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
