...
import { OMNIDEF } from './inwib2cRepechageEnglish_def.js';
import tmpl from './inwib2cRepechageEnglish.html';
import tmpl_nds from './inwib2cRepechageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRepechageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
