...
import { OMNIDEF } from './inwib2cIdentificationPDVVEnglish_def.js';
import tmpl from './inwib2cIdentificationPDVVEnglish.html';
import tmpl_nds from './inwib2cIdentificationPDVVEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cIdentificationPDVVEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
