...
import { OMNIDEF } from './inwi360CreateCaseFrench_def.js';
import tmpl from './inwi360CreateCaseFrench.html';
import tmpl_nds from './inwi360CreateCaseFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360CreateCaseFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
