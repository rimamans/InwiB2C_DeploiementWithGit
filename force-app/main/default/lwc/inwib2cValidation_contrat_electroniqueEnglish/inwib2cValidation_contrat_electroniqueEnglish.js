...
import { OMNIDEF } from './inwib2cValidation_contrat_electroniqueEnglish_def.js';
import tmpl from './inwib2cValidation_contrat_electroniqueEnglish.html';
import tmpl_nds from './inwib2cValidation_contrat_electroniqueEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cValidation_contrat_electroniqueEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
