...
import { OMNIDEF } from './inwiDisplayDemandeAdresseIAMEnglish_def.js';
import tmpl from './inwiDisplayDemandeAdresseIAMEnglish.html';
import tmpl_nds from './inwiDisplayDemandeAdresseIAMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwiDisplayDemandeAdresseIAMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
