...
import { OMNIDEF } from './inwib2cGenDocContratLWCEnglish_def.js';
import tmpl from './inwib2cGenDocContratLWCEnglish.html';
import tmpl_nds from './inwib2cGenDocContratLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGenDocContratLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
