...
import template from './inwiB2C_DisplaySub.html';
...
export default class inwiB2C_DisplaySub extends OmniscriptBaseMixin(NavigationMixin(LightningElement)) {
    constructor() {
        super();
    ...
    handleSubSelection(event) {
        ...
        console.log('selectedsubscription.Id: ' + selectedsubscription.Id)
