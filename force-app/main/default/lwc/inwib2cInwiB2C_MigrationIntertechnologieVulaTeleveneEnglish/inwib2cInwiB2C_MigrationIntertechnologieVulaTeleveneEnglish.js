...
import { OMNIDEF } from './inwib2cInwiB2C_MigrationIntertechnologieVulaTeleveneEnglish_def.js';
import tmpl from './inwib2cInwiB2C_MigrationIntertechnologieVulaTeleveneEnglish.html';
import tmpl_nds from './inwib2cInwiB2C_MigrationIntertechnologieVulaTeleveneEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_MigrationIntertechnologieVulaTeleveneEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
