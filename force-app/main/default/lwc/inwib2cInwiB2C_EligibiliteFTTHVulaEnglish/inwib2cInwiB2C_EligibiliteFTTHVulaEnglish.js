...
import { OMNIDEF } from './inwib2cInwiB2C_EligibiliteFTTHVulaEnglish_def.js';
import tmpl from './inwib2cInwiB2C_EligibiliteFTTHVulaEnglish.html';
import tmpl_nds from './inwib2cInwiB2C_EligibiliteFTTHVulaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_EligibiliteFTTHVulaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
