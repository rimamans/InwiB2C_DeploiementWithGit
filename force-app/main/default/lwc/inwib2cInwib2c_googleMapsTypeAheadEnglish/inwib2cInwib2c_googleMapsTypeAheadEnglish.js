...
import { OMNIDEF } from './inwib2cInwib2c_googleMapsTypeAheadEnglish_def.js';
import tmpl from './inwib2cInwib2c_googleMapsTypeAheadEnglish.html';
import tmpl_nds from './inwib2cInwib2c_googleMapsTypeAheadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwib2c_googleMapsTypeAheadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
