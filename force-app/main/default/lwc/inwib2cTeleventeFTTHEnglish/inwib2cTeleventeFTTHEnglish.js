...
import { OMNIDEF } from './inwib2cTeleventeFTTHEnglish_def.js';
import tmpl from './inwib2cTeleventeFTTHEnglish.html';
import tmpl_nds from './inwib2cTeleventeFTTHEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTeleventeFTTHEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
