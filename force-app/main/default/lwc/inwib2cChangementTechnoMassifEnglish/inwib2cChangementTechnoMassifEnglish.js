...
import { OMNIDEF } from './inwib2cChangementTechnoMassifEnglish_def.js';
import tmpl from './inwib2cChangementTechnoMassifEnglish.html';
import tmpl_nds from './inwib2cChangementTechnoMassifEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cChangementTechnoMassifEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
