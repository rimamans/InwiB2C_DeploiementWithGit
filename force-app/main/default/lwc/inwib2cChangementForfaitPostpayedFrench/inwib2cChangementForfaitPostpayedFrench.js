...
import { OMNIDEF } from './inwib2cChangementForfaitPostpayedFrench_def.js';
import tmpl from './inwib2cChangementForfaitPostpayedFrench.html';
import tmpl_nds from './inwib2cChangementForfaitPostpayedFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cChangementForfaitPostpayedFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
