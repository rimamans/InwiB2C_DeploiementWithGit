...
import { OMNIDEF } from './inwib2cTeleventeFtthVulaLivraisonAgenceV2French_def.js';
import tmpl from './inwib2cTeleventeFtthVulaLivraisonAgenceV2French.html';
import tmpl_nds from './inwib2cTeleventeFtthVulaLivraisonAgenceV2French_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTeleventeFtthVulaLivraisonAgenceV2French extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
