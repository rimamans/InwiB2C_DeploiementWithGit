...
import { OMNIDEF } from './inwib2cLivraisonDomicileFrench_def.js';
import tmpl from './inwib2cLivraisonDomicileFrench.html';
import tmpl_nds from './inwib2cLivraisonDomicileFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cLivraisonDomicileFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
