...
import { OMNIDEF } from './inwib2cMigrationPrePostAvecIdentificationFrench_def.js';
import tmpl from './inwib2cMigrationPrePostAvecIdentificationFrench.html';
import tmpl_nds from './inwib2cMigrationPrePostAvecIdentificationFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationPrePostAvecIdentificationFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
