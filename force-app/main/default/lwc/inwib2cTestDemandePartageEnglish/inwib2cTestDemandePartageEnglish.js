...
import { OMNIDEF } from './inwib2cTestDemandePartageEnglish_def.js';
import tmpl from './inwib2cTestDemandePartageEnglish.html';
import tmpl_nds from './inwib2cTestDemandePartageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTestDemandePartageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
