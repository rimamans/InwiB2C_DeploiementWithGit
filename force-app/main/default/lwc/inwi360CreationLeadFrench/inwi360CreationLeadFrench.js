...
import { OMNIDEF } from './inwi360CreationLeadFrench_def.js';
import tmpl from './inwi360CreationLeadFrench.html';
import tmpl_nds from './inwi360CreationLeadFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360CreationLeadFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
