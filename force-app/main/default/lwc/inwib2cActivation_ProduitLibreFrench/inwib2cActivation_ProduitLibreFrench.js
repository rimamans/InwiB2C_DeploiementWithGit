...
import { OMNIDEF } from './inwib2cActivation_ProduitLibreFrench_def.js';
import tmpl from './inwib2cActivation_ProduitLibreFrench.html';
import tmpl_nds from './inwib2cActivation_ProduitLibreFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cActivation_ProduitLibreFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
