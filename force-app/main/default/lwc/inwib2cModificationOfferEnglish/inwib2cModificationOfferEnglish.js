...
import { OMNIDEF } from './inwib2cModificationOfferEnglish_def.js';
import tmpl from './inwib2cModificationOfferEnglish.html';
import tmpl_nds from './inwib2cModificationOfferEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cModificationOfferEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
