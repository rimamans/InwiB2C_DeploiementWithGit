...
import { OMNIDEF } from './inwib2cDisplaySubAssetEnglish_def.js';
import tmpl from './inwib2cDisplaySubAssetEnglish.html';
import tmpl_nds from './inwib2cDisplaySubAssetEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cDisplaySubAssetEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
