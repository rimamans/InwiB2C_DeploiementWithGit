...
import { OMNIDEF } from './inwib2cRetention_ADSLFrench_def.js';
import tmpl from './inwib2cRetention_ADSLFrench.html';
import tmpl_nds from './inwib2cRetention_ADSLFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRetention_ADSLFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
