...
import { OMNIDEF } from './inwib2cInwiB2C_RecapOrderFrench_def.js';
import tmpl from './inwib2cInwiB2C_RecapOrderFrench.html';
import tmpl_nds from './inwib2cInwiB2C_RecapOrderFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_RecapOrderFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
