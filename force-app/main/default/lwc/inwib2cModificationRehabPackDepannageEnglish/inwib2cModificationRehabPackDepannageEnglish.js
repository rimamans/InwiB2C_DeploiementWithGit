...
import { OMNIDEF } from './inwib2cModificationRehabPackDepannageEnglish_def.js';
import tmpl from './inwib2cModificationRehabPackDepannageEnglish.html';
import tmpl_nds from './inwib2cModificationRehabPackDepannageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cModificationRehabPackDepannageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
