...
import { OMNIDEF } from './inwib2cMigrationInterGameIdarEnglish_def.js';
import tmpl from './inwib2cMigrationInterGameIdarEnglish.html';
import tmpl_nds from './inwib2cMigrationInterGameIdarEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationInterGameIdarEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
