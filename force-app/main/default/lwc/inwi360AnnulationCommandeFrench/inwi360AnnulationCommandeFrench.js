...
import { OMNIDEF } from './inwi360AnnulationCommandeFrench_def.js';
import tmpl from './inwi360AnnulationCommandeFrench.html';
import tmpl_nds from './inwi360AnnulationCommandeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360AnnulationCommandeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
