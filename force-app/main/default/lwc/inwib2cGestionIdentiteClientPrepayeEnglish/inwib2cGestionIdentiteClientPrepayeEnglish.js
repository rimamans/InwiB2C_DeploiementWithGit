...
import { OMNIDEF } from './inwib2cGestionIdentiteClientPrepayeEnglish_def.js';
import tmpl from './inwib2cGestionIdentiteClientPrepayeEnglish.html';
import tmpl_nds from './inwib2cGestionIdentiteClientPrepayeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGestionIdentiteClientPrepayeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
