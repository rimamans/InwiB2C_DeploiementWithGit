...
import { OMNIDEF } from './inwib2cGestionIdentiteAM11French_def.js';
import tmpl from './inwib2cGestionIdentiteAM11French.html';
import tmpl_nds from './inwib2cGestionIdentiteAM11French_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGestionIdentiteAM11French extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
