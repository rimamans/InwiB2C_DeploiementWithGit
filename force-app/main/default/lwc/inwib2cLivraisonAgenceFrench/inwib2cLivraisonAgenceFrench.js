...
import { OMNIDEF } from './inwib2cLivraisonAgenceFrench_def.js';
import tmpl from './inwib2cLivraisonAgenceFrench.html';
import tmpl_nds from './inwib2cLivraisonAgenceFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cLivraisonAgenceFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
