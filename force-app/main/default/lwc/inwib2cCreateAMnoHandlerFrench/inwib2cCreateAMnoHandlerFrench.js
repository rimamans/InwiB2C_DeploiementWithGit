...
import { OMNIDEF } from './inwib2cCreateAMnoHandlerFrench_def.js';
import tmpl from './inwib2cCreateAMnoHandlerFrench.html';
import tmpl_nds from './inwib2cCreateAMnoHandlerFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCreateAMnoHandlerFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
