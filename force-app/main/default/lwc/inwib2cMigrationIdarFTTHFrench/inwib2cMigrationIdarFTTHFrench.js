...
import { OMNIDEF } from './inwib2cMigrationIdarFTTHFrench_def.js';
import tmpl from './inwib2cMigrationIdarFTTHFrench.html';
import tmpl_nds from './inwib2cMigrationIdarFTTHFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationIdarFTTHFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
