...
import { OMNIDEF } from './createUsersTESTEnglish_def.js';
import tmpl from './createUsersTESTEnglish.html';
import tmpl_nds from './createUsersTESTEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createUsersTESTEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
