...
import { OMNIDEF } from './inwib2cDisconnectPostpayedServiceFrench_def.js';
import tmpl from './inwib2cDisconnectPostpayedServiceFrench.html';
import tmpl_nds from './inwib2cDisconnectPostpayedServiceFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cDisconnectPostpayedServiceFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
