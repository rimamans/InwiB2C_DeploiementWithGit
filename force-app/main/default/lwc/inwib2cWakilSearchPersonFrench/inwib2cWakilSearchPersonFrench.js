...
import { OMNIDEF } from './inwib2cWakilSearchPersonFrench_def.js';
import tmpl from './inwib2cWakilSearchPersonFrench.html';
import tmpl_nds from './inwib2cWakilSearchPersonFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cWakilSearchPersonFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
