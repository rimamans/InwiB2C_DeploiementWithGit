...
import { OMNIDEF } from './inwib2cChangement_Forfait_CameleonEnglish_def.js';
import tmpl from './inwib2cChangement_Forfait_CameleonEnglish.html';
import tmpl_nds from './inwib2cChangement_Forfait_CameleonEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cChangement_Forfait_CameleonEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
