...
import { OMNIDEF } from './inwib2cMigrationPREPOST_BackOfficeDistriFrench_def.js';
import tmpl from './inwib2cMigrationPREPOST_BackOfficeDistriFrench.html';
import tmpl_nds from './inwib2cMigrationPREPOST_BackOfficeDistriFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationPREPOST_BackOfficeDistriFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
