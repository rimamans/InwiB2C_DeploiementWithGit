...
import { OMNIDEF } from './inwib2cRemboursementClientEnglish_def.js';
import tmpl from './inwib2cRemboursementClientEnglish.html';
import tmpl_nds from './inwib2cRemboursementClientEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRemboursementClientEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
