...
import { OMNIDEF } from './inwib2cInwiB2C_ContentServicesEnglish_def.js';
import tmpl from './inwib2cInwiB2C_ContentServicesEnglish.html';
import tmpl_nds from './inwib2cInwiB2C_ContentServicesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_ContentServicesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
