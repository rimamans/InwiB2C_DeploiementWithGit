...
import { OMNIDEF } from './inwi360RecyclageAnnulationOrderD2DFrench_def.js';
import tmpl from './inwi360RecyclageAnnulationOrderD2DFrench.html';
import tmpl_nds from './inwi360RecyclageAnnulationOrderD2DFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360RecyclageAnnulationOrderD2DFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
