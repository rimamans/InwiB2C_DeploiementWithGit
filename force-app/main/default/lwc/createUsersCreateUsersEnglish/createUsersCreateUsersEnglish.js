...
import { OMNIDEF } from './createUsersCreateUsersEnglish_def.js';
import tmpl from './createUsersCreateUsersEnglish.html';
import tmpl_nds from './createUsersCreateUsersEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createUsersCreateUsersEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
