...
import { OMNIDEF } from './inwib2cInwib2C_modifiacation_coordonnees_bancairesFrench_def.js';
import tmpl from './inwib2cInwib2C_modifiacation_coordonnees_bancairesFrench.html';
import tmpl_nds from './inwib2cInwib2C_modifiacation_coordonnees_bancairesFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwib2C_modifiacation_coordonnees_bancairesFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
