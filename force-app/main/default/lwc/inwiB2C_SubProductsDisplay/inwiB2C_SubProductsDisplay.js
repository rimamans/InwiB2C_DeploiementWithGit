...
import template from './inwiB2C_SubProductsDisplay.html';
...
export default class InwiB2C_SubProductsDisplay extends OmniscriptBaseMixin(NavigationMixin(LightningElement)) {
    ...
    handleactionsubproducts(event) {
        ...
        // let userValues = {"Action" : event.detail.action.name ,
                ...
                this._actionUtilClass
                    ...
                    .then(response => {
                        ...
                        const params = {
                            ...
                            options: '{"Partenaire":"'+this.partenaire+'","TypeModification":"InwiB2C_Activation","SubscriptionId":"'+this.subid+'","StatutOperation":"'+this.status+'","Canal":"'+this.canal+'","SousProduitIN":"' +orderItemId+'","Description":"' +orderItemName+'","Mdn":"'+this.numeromdn+'","TypeAction":"InwiB2C_ServicesPassetsousproduitIN" }',
                        };
                    ...
                    this._actionUtilClass
                        ...
                        .then(response => {
                            ...
                            const params3 = {
                                ...
                                sClassName: 'InwiB2C_OperationHistory',
                                sMethodName: 'AddOperationHistory',
                                options: '{"Partenaire":"'+this.partenaire+'","TypeModification":"InwiB2C_Desactivation","SubscriptionId":"'+this.subid+'","StatutOperation":"'+this.status+'","Canal":"'+this.canal+'","SousProduitIN":"' +orderItemId+'","Description":"' +orderItemName+'","Mdn":"'+this.numeromdn+'","TypeAction":"InwiB2C_ServicesPassetsousproduitIN" }',
                            };
                    ...
                    this._actionUtilClass
                        ...
                        .then(response => {
                            ...
                            const params5 = {
                                ...
                                sClassName: 'InwiB2C_OperationHistory',
                                sMethodName: 'AddOperationHistory',
                                options: '{"Partenaire":"'+this.partenaire+'","TypeModification":"InwiB2C_Reconduction","SubscriptionId":"'+this.subid+'","StatutOperation":"'+this.status+'","Canal":"'+this.canal+'","SousProduitIN":"' +orderItemId+'","Description":"' +orderItemName+'","Mdn":"'+this.numeromdn+'","TypeAction":"InwiB2C_ServicesPassetsousproduitIN" }',
                            };
