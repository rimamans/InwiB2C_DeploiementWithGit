...
import { OMNIDEF } from './inwib2cRehabilitationFacturationEnglish_def.js';
import tmpl from './inwib2cRehabilitationFacturationEnglish.html';
import tmpl_nds from './inwib2cRehabilitationFacturationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRehabilitationFacturationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
