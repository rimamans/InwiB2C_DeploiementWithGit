...
import { OMNIDEF } from './inwib2cSearchadresseIntrouvableEnglish_def.js';
import tmpl from './inwib2cSearchadresseIntrouvableEnglish.html';
import tmpl_nds from './inwib2cSearchadresseIntrouvableEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSearchadresseIntrouvableEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
