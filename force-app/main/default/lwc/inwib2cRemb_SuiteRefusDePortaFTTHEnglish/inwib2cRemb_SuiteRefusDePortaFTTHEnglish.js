...
import { OMNIDEF } from './inwib2cRemb_SuiteRefusDePortaFTTHEnglish_def.js';
import tmpl from './inwib2cRemb_SuiteRefusDePortaFTTHEnglish.html';
import tmpl_nds from './inwib2cRemb_SuiteRefusDePortaFTTHEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRemb_SuiteRefusDePortaFTTHEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
