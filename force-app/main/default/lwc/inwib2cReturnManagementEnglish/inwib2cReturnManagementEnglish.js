...
import { OMNIDEF } from './inwib2cReturnManagementEnglish_def.js';
import tmpl from './inwib2cReturnManagementEnglish.html';
import tmpl_nds from './inwib2cReturnManagementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cReturnManagementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
