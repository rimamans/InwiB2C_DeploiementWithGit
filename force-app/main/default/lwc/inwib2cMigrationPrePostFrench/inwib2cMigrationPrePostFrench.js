...
import { OMNIDEF } from './inwib2cMigrationPrePostFrench_def.js';
import tmpl from './inwib2cMigrationPrePostFrench.html';
import tmpl_nds from './inwib2cMigrationPrePostFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationPrePostFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
