...
import { OMNIDEF } from './inwib2cUpdateAgenceSuperviseurFrench_def.js';
import tmpl from './inwib2cUpdateAgenceSuperviseurFrench.html';
import tmpl_nds from './inwib2cUpdateAgenceSuperviseurFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cUpdateAgenceSuperviseurFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
