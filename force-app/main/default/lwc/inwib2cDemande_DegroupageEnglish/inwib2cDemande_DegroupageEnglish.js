...
import { OMNIDEF } from './inwib2cDemande_DegroupageEnglish_def.js';
import tmpl from './inwib2cDemande_DegroupageEnglish.html';
import tmpl_nds from './inwib2cDemande_DegroupageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cDemande_DegroupageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
