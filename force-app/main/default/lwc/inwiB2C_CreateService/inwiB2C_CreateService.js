...
import template from "./inwiB2C_CreateService.html";
import { NavigationMixin } from "lightning/navigation";
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { getNamespaceDotNotation } from 'vlocity_cmt/omniscriptInternalUtils';
import { OmniscriptActionCommonUtil } from 'vlocity_cmt/omniscriptActionUtils';

export default class inwiB2C_CreateService   extends OmniscriptBaseMixin(
...
{    
   ...
   __list;
    ...
    createAccount(){
        ...
        let input;
          // if(this.step12==true){
           input ='{"region": "'+this.region+'","ville": "'+this.villeid+'","parentId": "'+this.accountid+'","codepostale":"'+this.codepostal+'","complement":"'+this.complementaddress+'","quartier":"'+this.quartier+'","precisionquartier":"'+this.pquartier+'","nomsite":"'+this.nomsite+'"}';
...
handleChangeSearch(event){
     ...
     // this.stepAd=true;
      ...
      handleSelectPlaque(event){
        console.log('city: ' + event.target.dataset.city);
          ...
          console.log('statut', event.target.dataset.statut);
        this.idadress = event.target.dataset.idline;
        console.log('adressId: ' + this.idadress);
        let selectedInfo = { 
          "city" : event.target.dataset.city,
    ...
    hideModalBox() {  
        this.isShowModal = false;
         ...
         checkField(){
            if(this.step12==true && this.nomsite!=null && this.nomsite!='' && this.region !=null && this.villeid!=null && (this.quartier !=null || this.pquartier!=null) && this.complementaddress !=null && this.complementaddress !=''){
                
                this.showModalBox();
            
            }else if(this.step12==false && this.nomsite!=null && this.nomsite!=''){
                this.showModalBox();
            }else{
                console.log('in else');
