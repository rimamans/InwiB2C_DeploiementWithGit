...
import { OMNIDEF } from './inwi360SearchAnAccountWafaCashEnglish_def.js';
import tmpl from './inwi360SearchAnAccountWafaCashEnglish.html';
import tmpl_nds from './inwi360SearchAnAccountWafaCashEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360SearchAnAccountWafaCashEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
