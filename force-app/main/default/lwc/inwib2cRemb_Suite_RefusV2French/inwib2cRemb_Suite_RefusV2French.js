...
import { OMNIDEF } from './inwib2cRemb_Suite_RefusV2French_def.js';
import tmpl from './inwib2cRemb_Suite_RefusV2French.html';
import tmpl_nds from './inwib2cRemb_Suite_RefusV2French_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRemb_Suite_RefusV2French extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
