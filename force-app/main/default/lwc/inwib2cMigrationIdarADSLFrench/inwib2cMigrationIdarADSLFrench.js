...
import { OMNIDEF } from './inwib2cMigrationIdarADSLFrench_def.js';
import tmpl from './inwib2cMigrationIdarADSLFrench.html';
import tmpl_nds from './inwib2cMigrationIdarADSLFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationIdarADSLFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
