...
import { OMNIDEF } from './inwib2cGestionIdentiteAMFrench_def.js';
import tmpl from './inwib2cGestionIdentiteAMFrench.html';
import tmpl_nds from './inwib2cGestionIdentiteAMFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGestionIdentiteAMFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
