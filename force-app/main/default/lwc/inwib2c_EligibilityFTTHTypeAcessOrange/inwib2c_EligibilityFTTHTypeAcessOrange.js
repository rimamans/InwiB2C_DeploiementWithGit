...
export default class Inwib2c_EligibilityFTTHTypeAcessOrange extends OmniscriptBaseMixin(
...
// apppel a la vip qui va retourner l'elegibilité begin
 ...
 this._actionUtilClass = new OmniscriptActionCommonUtil();
      ...
      // Vérification des champs nécessaires
          ...
          input = '{"operateur":"orange", "ND": "' + this.ND + '" , "IdClient": "' + this.IdClient + '" , "RIO": "' + this.RIO + '"}'; // Y_MH MGEN3790 FTTH-Transfert à 3 
