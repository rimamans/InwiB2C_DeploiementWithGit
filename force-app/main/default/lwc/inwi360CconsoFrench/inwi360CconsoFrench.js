...
import { OMNIDEF } from './inwi360CconsoFrench_def.js';
import tmpl from './inwi360CconsoFrench.html';
import tmpl_nds from './inwi360CconsoFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360CconsoFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
