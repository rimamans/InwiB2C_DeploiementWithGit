...
import { OMNIDEF } from './inwib2cInfosTechniquesEnglish_def.js';
import tmpl from './inwib2cInfosTechniquesEnglish.html';
import tmpl_nds from './inwib2cInfosTechniquesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInfosTechniquesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
