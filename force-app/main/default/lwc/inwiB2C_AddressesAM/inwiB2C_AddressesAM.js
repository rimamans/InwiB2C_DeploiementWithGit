...
import template from './inwiB2C_AddressesAM.html';
...
export default class inwiB2C_AddressesAM extends OmniscriptBaseMixin(NavigationMixin(LightningElement)) {
    ...
    ChangeSousRegion(event) {
        this.omniUpdateDataJson({ "SousRegion": event.detail.value });
    }
