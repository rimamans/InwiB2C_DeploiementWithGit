...
import { OMNIDEF } from './inwib2cGestionIdentiteAMEnglish_def.js';
import tmpl from './inwib2cGestionIdentiteAMEnglish.html';
import tmpl_nds from './inwib2cGestionIdentiteAMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGestionIdentiteAMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
