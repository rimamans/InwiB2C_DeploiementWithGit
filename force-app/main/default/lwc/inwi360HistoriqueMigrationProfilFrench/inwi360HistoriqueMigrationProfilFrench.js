...
import { OMNIDEF } from './inwi360HistoriqueMigrationProfilFrench_def.js';
import tmpl from './inwi360HistoriqueMigrationProfilFrench.html';
import tmpl_nds from './inwi360HistoriqueMigrationProfilFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360HistoriqueMigrationProfilFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
