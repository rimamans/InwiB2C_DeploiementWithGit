...
export default class Inwib2c_SiteFTTHVulaOnlyIAM  extends OmniscriptBaseMixin(
...
//MGEN3729 FTTH_VULA éligibilité exigences ANR
        if (this.infrastructure == 'IAM') {
            if(this.statutligne == 'active') {
              ...
              this.typeAccesInternet = 'Aucun accès' ; 
              this.disableTypeAcess = false ; 
              ...
              this.typeIdentifiant = 'ND'
              this.showBoxNum = true ;
              this.ShowTypeIdentifiant = false ;
              this.typeAccesOptions = [
              ...
              { label: 'Aucun accès', value: 'Aucun accès' }
                ...
                console.log("infrastructure connectedcallback OUT IF ", this.infrastructure) ;
                console.log("login connectedcallback OUT IF ", this.login) ;
                console.log("statutLigne connectedcallback OUT IF ", this.statutLigne) ;
