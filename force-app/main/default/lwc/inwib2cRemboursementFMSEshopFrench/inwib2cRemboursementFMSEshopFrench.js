...
import { OMNIDEF } from './inwib2cRemboursementFMSEshopFrench_def.js';
import tmpl from './inwib2cRemboursementFMSEshopFrench.html';
import tmpl_nds from './inwib2cRemboursementFMSEshopFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRemboursementFMSEshopFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
