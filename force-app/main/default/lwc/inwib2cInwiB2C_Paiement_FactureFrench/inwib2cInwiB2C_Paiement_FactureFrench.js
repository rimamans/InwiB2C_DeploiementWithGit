...
import { OMNIDEF } from './inwib2cInwiB2C_Paiement_FactureFrench_def.js';
import tmpl from './inwib2cInwiB2C_Paiement_FactureFrench.html';
import tmpl_nds from './inwib2cInwiB2C_Paiement_FactureFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_Paiement_FactureFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
