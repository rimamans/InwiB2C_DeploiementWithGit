...
import { OMNIDEF } from './inwib2cMigrationIntertechnologieVulaTeleventeEnglish_def.js';
import tmpl from './inwib2cMigrationIntertechnologieVulaTeleventeEnglish.html';
import tmpl_nds from './inwib2cMigrationIntertechnologieVulaTeleventeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationIntertechnologieVulaTeleventeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
