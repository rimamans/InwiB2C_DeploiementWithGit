...
import { OMNIDEF } from './inwib2cMigrationFTTHORADSLversIDARFrench_def.js';
import tmpl from './inwib2cMigrationFTTHORADSLversIDARFrench.html';
import tmpl_nds from './inwib2cMigrationFTTHORADSLversIDARFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationFTTHORADSLversIDARFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
