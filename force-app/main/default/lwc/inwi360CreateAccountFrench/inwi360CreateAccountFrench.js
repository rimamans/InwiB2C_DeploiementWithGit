...
import { OMNIDEF } from './inwi360CreateAccountFrench_def.js';
import tmpl from './inwi360CreateAccountFrench.html';
import tmpl_nds from './inwi360CreateAccountFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360CreateAccountFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
