...
import { OMNIDEF } from './inwib2cInwiB2C_ModificationPlafondRisqueEnglish_def.js';
import tmpl from './inwib2cInwiB2C_ModificationPlafondRisqueEnglish.html';
import tmpl_nds from './inwib2cInwiB2C_ModificationPlafondRisqueEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_ModificationPlafondRisqueEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
