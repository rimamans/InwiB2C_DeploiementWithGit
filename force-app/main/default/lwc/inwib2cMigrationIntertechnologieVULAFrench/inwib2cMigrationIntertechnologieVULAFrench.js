...
import { OMNIDEF } from './inwib2cMigrationIntertechnologieVULAFrench_def.js';
import tmpl from './inwib2cMigrationIntertechnologieVULAFrench.html';
import tmpl_nds from './inwib2cMigrationIntertechnologieVULAFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationIntertechnologieVULAFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
