...
import { OMNIDEF } from './inwib2cEshopLivraisonDomicileEnglish_def.js';
import tmpl from './inwib2cEshopLivraisonDomicileEnglish.html';
import tmpl_nds from './inwib2cEshopLivraisonDomicileEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cEshopLivraisonDomicileEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
