...
import { OMNIDEF } from './inwiInwiB2C_DisplayRechargeFrench_def.js';
import tmpl from './inwiInwiB2C_DisplayRechargeFrench.html';
import tmpl_nds from './inwiInwiB2C_DisplayRechargeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwiInwiB2C_DisplayRechargeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
