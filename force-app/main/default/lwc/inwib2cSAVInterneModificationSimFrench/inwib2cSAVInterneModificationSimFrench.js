...
import { OMNIDEF } from './inwib2cSAVInterneModificationSimFrench_def.js';
import tmpl from './inwib2cSAVInterneModificationSimFrench.html';
import tmpl_nds from './inwib2cSAVInterneModificationSimFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSAVInterneModificationSimFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
