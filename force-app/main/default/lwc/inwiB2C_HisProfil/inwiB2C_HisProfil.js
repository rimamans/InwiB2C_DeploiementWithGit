...
import template from './inwiB2C_HisProfil.html';

export default class inwiB2C_HisProfil extends OmniscriptBaseMixin(LightningElement) {
    ...
    @track columns =[
        ...
        {fieldName: 'M_DATE', label: 'Date de migration', sortable: true,
        hideDefaultActions: true, type: "date", typeAttributes:{
            year: "numeric",
            month: "2-digit",
            day: "2-digit"
        }, editable: false},
        {fieldName: 'OLDPROFIL', label: 'Ancien profil', hideDefaultActions: true,type :"text" , editable: false
    },
    {fieldName: 'Libelle_Profil_OLD', label: 'Libellé ancien profil', hideDefaultActions: true,type :"text" , editable: false
    },
    
        {fieldName: 'NEWPROFIL', label: 'Nouveau profil', hideDefaultActions: true, type :"text" , editable: false
    },
    {fieldName: 'Libelle_Profil_NEW', label: 'Libellé nouveau profil', hideDefaultActions: true,type :"text" , editable: false
},
          {fieldName: 'M_CANAL', label: 'Canal', hideDefaultActions: true, type :"text" , editable: false}
