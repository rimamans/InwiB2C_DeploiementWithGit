...
import { OMNIDEF } from './inwib2cAMenMasseFrench_def.js';
import tmpl from './inwib2cAMenMasseFrench.html';
import tmpl_nds from './inwib2cAMenMasseFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cAMenMasseFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
