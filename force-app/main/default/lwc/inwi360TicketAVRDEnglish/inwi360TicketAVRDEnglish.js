...
import { OMNIDEF } from './inwi360TicketAVRDEnglish_def.js';
import tmpl from './inwi360TicketAVRDEnglish.html';
import tmpl_nds from './inwi360TicketAVRDEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360TicketAVRDEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
