...
import { OMNIDEF } from './inwib2cIdentificationEnglish_def.js';
import tmpl from './inwib2cIdentificationEnglish.html';
import tmpl_nds from './inwib2cIdentificationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cIdentificationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
