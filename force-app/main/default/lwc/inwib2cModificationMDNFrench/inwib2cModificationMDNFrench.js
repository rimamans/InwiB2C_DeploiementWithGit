...
import { OMNIDEF } from './inwib2cModificationMDNFrench_def.js';
import tmpl from './inwib2cModificationMDNFrench.html';
import tmpl_nds from './inwib2cModificationMDNFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cModificationMDNFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
