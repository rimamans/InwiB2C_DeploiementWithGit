...
import template from './inwiB2C_DisplaySearchedSubscritions_V2.html';

export default class InwiB2C_DisplaySearchedSubscritions_V2 extends OmniscriptBaseMixin(NavigationMixin(LightningElement)) {
