...
import { OMNIDEF } from './inwib2cEshopAgenceEnglish_def.js';
import tmpl from './inwib2cEshopAgenceEnglish.html';
import tmpl_nds from './inwib2cEshopAgenceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cEshopAgenceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
