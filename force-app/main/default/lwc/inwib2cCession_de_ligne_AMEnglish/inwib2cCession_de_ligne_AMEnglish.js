...
import { OMNIDEF } from './inwib2cCession_de_ligne_AMEnglish_def.js';
import tmpl from './inwib2cCession_de_ligne_AMEnglish.html';
import tmpl_nds from './inwib2cCession_de_ligne_AMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCession_de_ligne_AMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
