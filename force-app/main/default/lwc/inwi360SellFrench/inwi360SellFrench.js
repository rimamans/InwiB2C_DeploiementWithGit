...
import { OMNIDEF } from './inwi360SellFrench_def.js';
import tmpl from './inwi360SellFrench.html';
import tmpl_nds from './inwi360SellFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360SellFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
