...
import { OMNIDEF } from './inwib2cTESTEnglish_def.js';
import tmpl from './inwib2cTESTEnglish.html';
import tmpl_nds from './inwib2cTESTEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTESTEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
