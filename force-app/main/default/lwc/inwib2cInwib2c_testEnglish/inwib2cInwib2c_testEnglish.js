...
import { OMNIDEF } from './inwib2cInwib2c_testEnglish_def.js';
import tmpl from './inwib2cInwib2c_testEnglish.html';
import tmpl_nds from './inwib2cInwib2c_testEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwib2c_testEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
