...
import { OMNIDEF } from './inwi360SearchAnAccountWakilFrench_def.js';
import tmpl from './inwi360SearchAnAccountWakilFrench.html';
import tmpl_nds from './inwi360SearchAnAccountWakilFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360SearchAnAccountWakilFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
