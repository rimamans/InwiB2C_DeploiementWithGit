...
import { OMNIDEF } from './inwi360Promo_F_FEnglish_def.js';
import tmpl from './inwi360Promo_F_FEnglish.html';
import tmpl_nds from './inwi360Promo_F_FEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360Promo_F_FEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
