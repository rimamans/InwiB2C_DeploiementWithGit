...
import { OMNIDEF } from './inwib2cRepriseD2DMigrationInterTechnologieEnglish_def.js';
import tmpl from './inwib2cRepriseD2DMigrationInterTechnologieEnglish.html';
import tmpl_nds from './inwib2cRepriseD2DMigrationInterTechnologieEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRepriseD2DMigrationInterTechnologieEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
