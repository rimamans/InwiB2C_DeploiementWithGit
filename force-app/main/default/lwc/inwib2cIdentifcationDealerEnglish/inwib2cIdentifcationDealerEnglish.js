...
import { OMNIDEF } from './inwib2cIdentifcationDealerEnglish_def.js';
import tmpl from './inwib2cIdentifcationDealerEnglish.html';
import tmpl_nds from './inwib2cIdentifcationDealerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cIdentifcationDealerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
