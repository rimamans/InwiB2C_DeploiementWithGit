...
import { OMNIDEF } from './inwib2cAnnulation_CommandeFrench_def.js';
import tmpl from './inwib2cAnnulation_CommandeFrench.html';
import tmpl_nds from './inwib2cAnnulation_CommandeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cAnnulation_CommandeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
