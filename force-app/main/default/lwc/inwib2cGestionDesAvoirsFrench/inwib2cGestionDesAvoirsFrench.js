...
import { OMNIDEF } from './inwib2cGestionDesAvoirsFrench_def.js';
import tmpl from './inwib2cGestionDesAvoirsFrench.html';
import tmpl_nds from './inwib2cGestionDesAvoirsFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGestionDesAvoirsFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
