...
import { OMNIDEF } from './inwi360ContactAnonymeFrench_def.js';
import tmpl from './inwi360ContactAnonymeFrench.html';
import tmpl_nds from './inwi360ContactAnonymeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360ContactAnonymeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
