...
import { OMNIDEF } from './inwib2cSynchronisationFicheClientFrench_def.js';
import tmpl from './inwib2cSynchronisationFicheClientFrench.html';
import tmpl_nds from './inwib2cSynchronisationFicheClientFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSynchronisationFicheClientFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
