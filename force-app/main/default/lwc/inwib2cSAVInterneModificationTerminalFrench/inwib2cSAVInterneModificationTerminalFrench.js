...
import { OMNIDEF } from './inwib2cSAVInterneModificationTerminalFrench_def.js';
import tmpl from './inwib2cSAVInterneModificationTerminalFrench.html';
import tmpl_nds from './inwib2cSAVInterneModificationTerminalFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSAVInterneModificationTerminalFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
