...
import { OMNIDEF } from './inwib2cINWIB2C_RechargeDealerSDPEnglish_def.js';
import tmpl from './inwib2cINWIB2C_RechargeDealerSDPEnglish.html';
import tmpl_nds from './inwib2cINWIB2C_RechargeDealerSDPEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cINWIB2C_RechargeDealerSDPEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
