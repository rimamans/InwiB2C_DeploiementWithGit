...
import { OMNIDEF } from './inwib2cInwiB2C_ModificationRehabFrench_def.js';
import tmpl from './inwib2cInwiB2C_ModificationRehabFrench.html';
import tmpl_nds from './inwib2cInwiB2C_ModificationRehabFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_ModificationRehabFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
