...
import { OMNIDEF } from './inwib2cDemandePartageVulaEnglish_def.js';
import tmpl from './inwib2cDemandePartageVulaEnglish.html';
import tmpl_nds from './inwib2cDemandePartageVulaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cDemandePartageVulaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
