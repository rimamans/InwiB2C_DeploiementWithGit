...
import { OMNIDEF } from './inwib2cInwiB2C_AssetGenerationEnglish_def.js';
import tmpl from './inwib2cInwiB2C_AssetGenerationEnglish.html';
import tmpl_nds from './inwib2cInwiB2C_AssetGenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_AssetGenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
