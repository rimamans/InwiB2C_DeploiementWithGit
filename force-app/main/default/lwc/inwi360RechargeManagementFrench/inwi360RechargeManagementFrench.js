...
import { OMNIDEF } from './inwi360RechargeManagementFrench_def.js';
import tmpl from './inwi360RechargeManagementFrench.html';
import tmpl_nds from './inwi360RechargeManagementFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360RechargeManagementFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
