...
import { OMNIDEF } from './inwib2cAnnulation_DemandeEnglish_def.js';
import tmpl from './inwib2cAnnulation_DemandeEnglish.html';
import tmpl_nds from './inwib2cAnnulation_DemandeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cAnnulation_DemandeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
