...
import { OMNIDEF } from './inwib2cAvoirBillingFrench_def.js';
import tmpl from './inwib2cAvoirBillingFrench.html';
import tmpl_nds from './inwib2cAvoirBillingFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cAvoirBillingFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
