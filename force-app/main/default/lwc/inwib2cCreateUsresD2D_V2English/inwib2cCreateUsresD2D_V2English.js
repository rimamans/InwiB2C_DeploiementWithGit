...
import { OMNIDEF } from './inwib2cCreateUsresD2D_V2English_def.js';
import tmpl from './inwib2cCreateUsresD2D_V2English.html';
import tmpl_nds from './inwib2cCreateUsresD2D_V2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCreateUsresD2D_V2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
