...
import { OMNIDEF } from './inwB2CMigrationInterGameIdarEnglish_def.js';
import tmpl from './inwB2CMigrationInterGameIdarEnglish.html';
import tmpl_nds from './inwB2CMigrationInterGameIdarEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwB2CMigrationInterGameIdarEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
