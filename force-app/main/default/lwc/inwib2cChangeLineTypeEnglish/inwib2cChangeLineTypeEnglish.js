...
import { OMNIDEF } from './inwib2cChangeLineTypeEnglish_def.js';
import tmpl from './inwib2cChangeLineTypeEnglish.html';
import tmpl_nds from './inwib2cChangeLineTypeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cChangeLineTypeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
