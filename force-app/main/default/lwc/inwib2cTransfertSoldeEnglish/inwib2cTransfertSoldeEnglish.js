...
import { OMNIDEF } from './inwib2cTransfertSoldeEnglish_def.js';
import tmpl from './inwib2cTransfertSoldeEnglish.html';
import tmpl_nds from './inwib2cTransfertSoldeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTransfertSoldeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
