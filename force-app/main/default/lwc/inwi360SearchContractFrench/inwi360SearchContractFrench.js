...
import { OMNIDEF } from './inwi360SearchContractFrench_def.js';
import tmpl from './inwi360SearchContractFrench.html';
import tmpl_nds from './inwi360SearchContractFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360SearchContractFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
