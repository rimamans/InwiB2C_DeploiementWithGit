...
import { OMNIDEF } from './inwib2cIdentificationAMFrench_def.js';
import tmpl from './inwib2cIdentificationAMFrench.html';
import tmpl_nds from './inwib2cIdentificationAMFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cIdentificationAMFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
