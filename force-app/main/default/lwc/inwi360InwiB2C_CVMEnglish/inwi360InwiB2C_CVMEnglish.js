...
import { OMNIDEF } from './inwi360InwiB2C_CVMEnglish_def.js';
import tmpl from './inwi360InwiB2C_CVMEnglish.html';
import tmpl_nds from './inwi360InwiB2C_CVMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360InwiB2C_CVMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
