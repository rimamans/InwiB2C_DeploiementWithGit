...
import { OMNIDEF } from './inwib2cVue360_billing_invoicesEnglish_def.js';
import tmpl from './inwib2cVue360_billing_invoicesEnglish.html';
import tmpl_nds from './inwib2cVue360_billing_invoicesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cVue360_billing_invoicesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
