...
import { OMNIDEF } from './inwib2cRecyclageCommandeFTTHTestEnglish_def.js';
import tmpl from './inwib2cRecyclageCommandeFTTHTestEnglish.html';
import tmpl_nds from './inwib2cRecyclageCommandeFTTHTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRecyclageCommandeFTTHTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
