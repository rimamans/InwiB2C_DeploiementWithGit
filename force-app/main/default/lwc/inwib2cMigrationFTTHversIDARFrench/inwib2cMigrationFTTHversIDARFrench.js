...
import { OMNIDEF } from './inwib2cMigrationFTTHversIDARFrench_def.js';
import tmpl from './inwib2cMigrationFTTHversIDARFrench.html';
import tmpl_nds from './inwib2cMigrationFTTHversIDARFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationFTTHversIDARFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
