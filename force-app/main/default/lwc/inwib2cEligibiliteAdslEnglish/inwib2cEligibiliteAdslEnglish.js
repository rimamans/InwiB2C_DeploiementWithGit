...
import { OMNIDEF } from './inwib2cEligibiliteAdslEnglish_def.js';
import tmpl from './inwib2cEligibiliteAdslEnglish.html';
import tmpl_nds from './inwib2cEligibiliteAdslEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cEligibiliteAdslEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
