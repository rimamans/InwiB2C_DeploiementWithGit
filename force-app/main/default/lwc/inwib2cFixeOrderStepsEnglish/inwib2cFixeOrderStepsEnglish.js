...
import { OMNIDEF } from './inwib2cFixeOrderStepsEnglish_def.js';
import tmpl from './inwib2cFixeOrderStepsEnglish.html';
import tmpl_nds from './inwib2cFixeOrderStepsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cFixeOrderStepsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
