...
export default class InwiB2C_GoogleMap extends OmniscriptBaseMixin(
  NavigationMixin(LightningElement)
) {
  vfRoot = "https://inwi-b2c--devevol--c.sandbox.vf.force.com"; //devEVOL
  //VF = https://inwi-b2c--devevol.sandbox.lightning.force.com
  ...
  async handleSearch() {
    ...
    try {
      ...
      if (iframe) {
        // iframe.contentWindow.postMessage({ name: "Geocodage", latitude, longitude, titre }, this.siteURL);
  ...
  async checkEligibilityFTTH() {
    ...
    this._actionUtil
      ...
      .then((response) => {
        ...
        // const operatorOI =eligibilityFTTHResp.operator;
        ...
        if (operatorOI === "IAM") {
          ...
          // this.isServiceAccIdCreated = true;
          // console.log("input orange", this.params);
          // });
