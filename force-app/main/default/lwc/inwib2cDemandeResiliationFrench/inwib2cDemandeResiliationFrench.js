...
import { OMNIDEF } from './inwib2cDemandeResiliationFrench_def.js';
import tmpl from './inwib2cDemandeResiliationFrench.html';
import tmpl_nds from './inwib2cDemandeResiliationFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cDemandeResiliationFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
