...
import { OMNIDEF } from './inwib2cAcquisitionFrench_def.js';
import tmpl from './inwib2cAcquisitionFrench.html';
import tmpl_nds from './inwib2cAcquisitionFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cAcquisitionFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
