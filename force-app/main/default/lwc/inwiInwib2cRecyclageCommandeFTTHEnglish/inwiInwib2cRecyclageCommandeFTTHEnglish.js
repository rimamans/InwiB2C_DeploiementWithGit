...
import { OMNIDEF } from './inwiInwib2cRecyclageCommandeFTTHEnglish_def.js';
import tmpl from './inwiInwib2cRecyclageCommandeFTTHEnglish.html';
import tmpl_nds from './inwiInwib2cRecyclageCommandeFTTHEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwiInwib2cRecyclageCommandeFTTHEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
