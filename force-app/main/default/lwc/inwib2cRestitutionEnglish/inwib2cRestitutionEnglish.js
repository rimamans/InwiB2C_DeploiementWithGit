...
import { OMNIDEF } from './inwib2cRestitutionEnglish_def.js';
import tmpl from './inwib2cRestitutionEnglish.html';
import tmpl_nds from './inwib2cRestitutionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRestitutionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
