...
import { OMNIDEF } from './inwib2cQualification_ContratEnglish_def.js';
import tmpl from './inwib2cQualification_ContratEnglish.html';
import tmpl_nds from './inwib2cQualification_ContratEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cQualification_ContratEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
