...
import { OMNIDEF } from './inwib2cProduitLibreReccurentEnglish_def.js';
import tmpl from './inwib2cProduitLibreReccurentEnglish.html';
import tmpl_nds from './inwib2cProduitLibreReccurentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cProduitLibreReccurentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
