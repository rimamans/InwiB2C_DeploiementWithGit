...
import { OMNIDEF } from './inwi360AssignCaseFrench_def.js';
import tmpl from './inwi360AssignCaseFrench.html';
import tmpl_nds from './inwi360AssignCaseFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360AssignCaseFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
