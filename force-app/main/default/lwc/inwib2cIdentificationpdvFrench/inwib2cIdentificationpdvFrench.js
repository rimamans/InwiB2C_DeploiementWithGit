...
import { OMNIDEF } from './inwib2cIdentificationpdvFrench_def.js';
import tmpl from './inwib2cIdentificationpdvFrench.html';
import tmpl_nds from './inwib2cIdentificationpdvFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cIdentificationpdvFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
