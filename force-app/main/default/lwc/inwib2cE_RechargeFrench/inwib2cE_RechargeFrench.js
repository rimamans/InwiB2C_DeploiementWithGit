...
import { OMNIDEF } from './inwib2cE_RechargeFrench_def.js';
import tmpl from './inwib2cE_RechargeFrench.html';
import tmpl_nds from './inwib2cE_RechargeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cE_RechargeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
