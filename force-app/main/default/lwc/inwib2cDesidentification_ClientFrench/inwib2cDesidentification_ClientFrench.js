...
import { OMNIDEF } from './inwib2cDesidentification_ClientFrench_def.js';
import tmpl from './inwib2cDesidentification_ClientFrench.html';
import tmpl_nds from './inwib2cDesidentification_ClientFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cDesidentification_ClientFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
