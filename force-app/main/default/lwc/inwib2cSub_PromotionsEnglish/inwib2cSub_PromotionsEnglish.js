...
import { OMNIDEF } from './inwib2cSub_PromotionsEnglish_def.js';
import tmpl from './inwib2cSub_PromotionsEnglish.html';
import tmpl_nds from './inwib2cSub_PromotionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSub_PromotionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
