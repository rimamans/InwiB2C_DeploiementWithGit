...
import { OMNIDEF } from './inwib2cTeleventeAgenceEnglish_def.js';
import tmpl from './inwib2cTeleventeAgenceEnglish.html';
import tmpl_nds from './inwib2cTeleventeAgenceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTeleventeAgenceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
