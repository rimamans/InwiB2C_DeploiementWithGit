...
import { OMNIDEF } from './inwib2cSWAPONTHV_Search_PersonFrench_def.js';
import tmpl from './inwib2cSWAPONTHV_Search_PersonFrench.html';
import tmpl_nds from './inwib2cSWAPONTHV_Search_PersonFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSWAPONTHV_Search_PersonFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
