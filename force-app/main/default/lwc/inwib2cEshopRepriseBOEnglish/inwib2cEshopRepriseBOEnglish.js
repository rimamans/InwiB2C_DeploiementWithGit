...
import { OMNIDEF } from './inwib2cEshopRepriseBOEnglish_def.js';
import tmpl from './inwib2cEshopRepriseBOEnglish.html';
import tmpl_nds from './inwib2cEshopRepriseBOEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cEshopRepriseBOEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
