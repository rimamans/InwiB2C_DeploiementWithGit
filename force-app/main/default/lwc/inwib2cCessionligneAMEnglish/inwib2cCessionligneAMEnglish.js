...
import { OMNIDEF } from './inwib2cCessionligneAMEnglish_def.js';
import tmpl from './inwib2cCessionligneAMEnglish.html';
import tmpl_nds from './inwib2cCessionligneAMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCessionligneAMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
