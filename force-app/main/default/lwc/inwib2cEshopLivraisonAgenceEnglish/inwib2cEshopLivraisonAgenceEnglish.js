...
import { OMNIDEF } from './inwib2cEshopLivraisonAgenceEnglish_def.js';
import tmpl from './inwib2cEshopLivraisonAgenceEnglish.html';
import tmpl_nds from './inwib2cEshopLivraisonAgenceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cEshopLivraisonAgenceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
