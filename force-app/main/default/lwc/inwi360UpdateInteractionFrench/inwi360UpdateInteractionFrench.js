...
import { OMNIDEF } from './inwi360UpdateInteractionFrench_def.js';
import tmpl from './inwi360UpdateInteractionFrench.html';
import tmpl_nds from './inwi360UpdateInteractionFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360UpdateInteractionFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
