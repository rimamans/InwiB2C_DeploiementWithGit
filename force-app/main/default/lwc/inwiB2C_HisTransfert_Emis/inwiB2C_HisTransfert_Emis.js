...
import template from './inwiB2C_HisTransfert_Emis.html';

export default class inwiB2C_HisTransfert_Emis extends OmniscriptBaseMixin(LightningElement) {
    ...
    @track columns = [
        ...
        {
            fieldName: 'MDN_DEST', label: 'Mdn bénéficiaire', hideDefaultActions: true, type: "text", editable: false
        },
        {fieldName: 'M_MONTANT_DEBIT', label: 'Montant transféré', hideDefaultActions: true, initialWidth: 180,type: 'currency', typeAttributes: { currencyCode: 'DHs' }}

      //  { fieldName: 'M_MONTANT_DEBIT', label: 'Montant transféré en DHs', hideDefaultActions: true, type: "text", editable: false }
