...
import { OMNIDEF } from './inwib2cActivateAnghamiEnglish_def.js';
import tmpl from './inwib2cActivateAnghamiEnglish.html';
import tmpl_nds from './inwib2cActivateAnghamiEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cActivateAnghamiEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
