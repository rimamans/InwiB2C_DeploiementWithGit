...
import { OMNIDEF } from './inwib2cModificationRDVFrench_def.js';
import tmpl from './inwib2cModificationRDVFrench.html';
import tmpl_nds from './inwib2cModificationRDVFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cModificationRDVFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
