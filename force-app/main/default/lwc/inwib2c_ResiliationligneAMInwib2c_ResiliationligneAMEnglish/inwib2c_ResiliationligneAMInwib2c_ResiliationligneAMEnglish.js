...
import { OMNIDEF } from './inwib2c_ResiliationligneAMInwib2c_ResiliationligneAMEnglish_def.js';
import tmpl from './inwib2c_ResiliationligneAMInwib2c_ResiliationligneAMEnglish.html';
import tmpl_nds from './inwib2c_ResiliationligneAMInwib2c_ResiliationligneAMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2c_ResiliationligneAMInwib2c_ResiliationligneAMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
