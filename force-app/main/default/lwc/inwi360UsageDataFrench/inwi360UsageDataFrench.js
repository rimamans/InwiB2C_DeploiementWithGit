...
import { OMNIDEF } from './inwi360UsageDataFrench_def.js';
import tmpl from './inwi360UsageDataFrench.html';
import tmpl_nds from './inwi360UsageDataFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360UsageDataFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
