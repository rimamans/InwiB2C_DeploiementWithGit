...
import { OMNIDEF } from './inwib2cGestionDesRetoursEnglish_def.js';
import tmpl from './inwib2cGestionDesRetoursEnglish.html';
import tmpl_nds from './inwib2cGestionDesRetoursEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGestionDesRetoursEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
