...
import { OMNIDEF } from './inwib2cSharingRequestEnglish_def.js';
import tmpl from './inwib2cSharingRequestEnglish.html';
import tmpl_nds from './inwib2cSharingRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSharingRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
