...
import { OMNIDEF } from './inwib2cCautionBillingFrench_def.js';
import tmpl from './inwib2cCautionBillingFrench.html';
import tmpl_nds from './inwib2cCautionBillingFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCautionBillingFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
