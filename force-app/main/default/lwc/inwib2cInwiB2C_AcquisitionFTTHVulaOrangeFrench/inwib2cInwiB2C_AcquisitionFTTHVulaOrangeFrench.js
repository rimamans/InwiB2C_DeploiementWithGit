...
import { OMNIDEF } from './inwib2cInwiB2C_AcquisitionFTTHVulaOrangeFrench_def.js';
import tmpl from './inwib2cInwiB2C_AcquisitionFTTHVulaOrangeFrench.html';
import tmpl_nds from './inwib2cInwiB2C_AcquisitionFTTHVulaOrangeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_AcquisitionFTTHVulaOrangeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
