...
export default class InwiB2C_input_cin extends OmniscriptBaseMixin(NavigationMixin(LightningElement)) {



    handleFilesChange(){
        try {
            var comboboxRetour = this.template.querySelector(`[data-customidrt="cintext"]`);
