...
import { OMNIDEF } from './inwib2cCheckEligibilityHome5GEnglish_def.js';
import tmpl from './inwib2cCheckEligibilityHome5GEnglish.html';
import tmpl_nds from './inwib2cCheckEligibilityHome5GEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCheckEligibilityHome5GEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
