...
import { OMNIDEF } from './inwi360SearchAnAccountFrench_def.js';
import tmpl from './inwi360SearchAnAccountFrench.html';
import tmpl_nds from './inwi360SearchAnAccountFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360SearchAnAccountFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
