...
import { OMNIDEF } from './inwib2cHistoriqueAvantageClubInwiEnglish_def.js';
import tmpl from './inwib2cHistoriqueAvantageClubInwiEnglish.html';
import tmpl_nds from './inwib2cHistoriqueAvantageClubInwiEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cHistoriqueAvantageClubInwiEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
