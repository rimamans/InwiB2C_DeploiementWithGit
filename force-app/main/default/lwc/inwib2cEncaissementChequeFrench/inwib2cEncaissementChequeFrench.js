...
import { OMNIDEF } from './inwib2cEncaissementChequeFrench_def.js';
import tmpl from './inwib2cEncaissementChequeFrench.html';
import tmpl_nds from './inwib2cEncaissementChequeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cEncaissementChequeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
