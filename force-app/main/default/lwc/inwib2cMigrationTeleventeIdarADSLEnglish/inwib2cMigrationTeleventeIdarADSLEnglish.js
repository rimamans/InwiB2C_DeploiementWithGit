...
import { OMNIDEF } from './inwib2cMigrationTeleventeIdarADSLEnglish_def.js';
import tmpl from './inwib2cMigrationTeleventeIdarADSLEnglish.html';
import tmpl_nds from './inwib2cMigrationTeleventeIdarADSLEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationTeleventeIdarADSLEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
