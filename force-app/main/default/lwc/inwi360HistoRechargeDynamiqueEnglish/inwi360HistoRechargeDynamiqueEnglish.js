...
import { OMNIDEF } from './inwi360HistoRechargeDynamiqueEnglish_def.js';
import tmpl from './inwi360HistoRechargeDynamiqueEnglish.html';
import tmpl_nds from './inwi360HistoRechargeDynamiqueEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360HistoRechargeDynamiqueEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
