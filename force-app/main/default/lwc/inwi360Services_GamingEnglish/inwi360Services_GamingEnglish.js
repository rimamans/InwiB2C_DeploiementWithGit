...
import { OMNIDEF } from './inwi360Services_GamingEnglish_def.js';
import tmpl from './inwi360Services_GamingEnglish.html';
import tmpl_nds from './inwi360Services_GamingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360Services_GamingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
