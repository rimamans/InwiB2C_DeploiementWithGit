...
import { OMNIDEF } from './inwib2cTeleventeRepriseBOEnglish_def.js';
import tmpl from './inwib2cTeleventeRepriseBOEnglish.html';
import tmpl_nds from './inwib2cTeleventeRepriseBOEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTeleventeRepriseBOEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
