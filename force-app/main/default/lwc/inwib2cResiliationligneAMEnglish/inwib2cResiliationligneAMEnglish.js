...
import { OMNIDEF } from './inwib2cResiliationligneAMEnglish_def.js';
import tmpl from './inwib2cResiliationligneAMEnglish.html';
import tmpl_nds from './inwib2cResiliationligneAMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cResiliationligneAMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
