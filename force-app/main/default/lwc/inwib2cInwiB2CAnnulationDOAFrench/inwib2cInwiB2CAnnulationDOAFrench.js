...
import { OMNIDEF } from './inwib2cInwiB2CAnnulationDOAFrench_def.js';
import tmpl from './inwib2cInwiB2CAnnulationDOAFrench.html';
import tmpl_nds from './inwib2cInwiB2CAnnulationDOAFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2CAnnulationDOAFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
