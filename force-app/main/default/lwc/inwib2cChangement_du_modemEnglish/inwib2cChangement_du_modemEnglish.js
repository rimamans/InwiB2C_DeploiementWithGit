...
import { OMNIDEF } from './inwib2cChangement_du_modemEnglish_def.js';
import tmpl from './inwib2cChangement_du_modemEnglish.html';
import tmpl_nds from './inwib2cChangement_du_modemEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cChangement_du_modemEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
