...
import { OMNIDEF } from './inwib2cIdentificationAMEnglish_def.js';
import tmpl from './inwib2cIdentificationAMEnglish.html';
import tmpl_nds from './inwib2cIdentificationAMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cIdentificationAMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
