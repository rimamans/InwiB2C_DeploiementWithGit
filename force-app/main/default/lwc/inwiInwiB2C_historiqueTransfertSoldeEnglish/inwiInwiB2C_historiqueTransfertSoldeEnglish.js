...
import { OMNIDEF } from './inwiInwiB2C_historiqueTransfertSoldeEnglish_def.js';
import tmpl from './inwiInwiB2C_historiqueTransfertSoldeEnglish.html';
import tmpl_nds from './inwiInwiB2C_historiqueTransfertSoldeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwiInwiB2C_historiqueTransfertSoldeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
