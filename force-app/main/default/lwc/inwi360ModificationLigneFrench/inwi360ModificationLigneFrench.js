...
import { OMNIDEF } from './inwi360ModificationLigneFrench_def.js';
import tmpl from './inwi360ModificationLigneFrench.html';
import tmpl_nds from './inwi360ModificationLigneFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360ModificationLigneFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
