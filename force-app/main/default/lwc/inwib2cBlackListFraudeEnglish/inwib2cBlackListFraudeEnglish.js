...
import { OMNIDEF } from './inwib2cBlackListFraudeEnglish_def.js';
import tmpl from './inwib2cBlackListFraudeEnglish.html';
import tmpl_nds from './inwib2cBlackListFraudeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cBlackListFraudeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
