...
import { OMNIDEF } from './inwib2cMigrationCampusConnectePrepayeEnglish_def.js';
import tmpl from './inwib2cMigrationCampusConnectePrepayeEnglish.html';
import tmpl_nds from './inwib2cMigrationCampusConnectePrepayeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationCampusConnectePrepayeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
