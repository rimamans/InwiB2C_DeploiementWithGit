...
import { OMNIDEF } from './inwib2cResiliationLignePrepayeEnglish_def.js';
import tmpl from './inwib2cResiliationLignePrepayeEnglish.html';
import tmpl_nds from './inwib2cResiliationLignePrepayeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cResiliationLignePrepayeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
