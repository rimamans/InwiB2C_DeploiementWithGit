...
import { OMNIDEF } from './inwib2cVulaEnglish_def.js';
import tmpl from './inwib2cVulaEnglish.html';
import tmpl_nds from './inwib2cVulaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cVulaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
