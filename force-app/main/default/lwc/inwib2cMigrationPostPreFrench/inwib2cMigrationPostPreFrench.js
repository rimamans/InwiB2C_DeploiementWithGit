...
import { OMNIDEF } from './inwib2cMigrationPostPreFrench_def.js';
import tmpl from './inwib2cMigrationPostPreFrench.html';
import tmpl_nds from './inwib2cMigrationPostPreFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationPostPreFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
