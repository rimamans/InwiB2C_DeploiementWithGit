...
import { OMNIDEF } from './inwi360InwiB2C_OSHistoRechargeFrench_def.js';
import tmpl from './inwi360InwiB2C_OSHistoRechargeFrench.html';
import tmpl_nds from './inwi360InwiB2C_OSHistoRechargeFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360InwiB2C_OSHistoRechargeFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
