...
import { OMNIDEF } from './inwib2cSuspensionFacturationEnglish_def.js';
import tmpl from './inwib2cSuspensionFacturationEnglish.html';
import tmpl_nds from './inwib2cSuspensionFacturationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSuspensionFacturationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
