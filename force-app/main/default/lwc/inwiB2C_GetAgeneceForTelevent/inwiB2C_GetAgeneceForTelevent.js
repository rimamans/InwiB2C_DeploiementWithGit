...
export default class InwiB2C_GetAgeneceForTelevent extends LightningElement {
    ...
    @api name;
    //@api code;
    obligatoryshowed=false;
  
      @api
   
     set obligatoryshowed(value) {
       this.__obligatoryshowed = value;
     }
     get obligatoryshowed() {
      return this.__obligatoryshowed;
    }
  ...
  gotonextStep(){
    if (this.value) {
        ...
        this.showToast('Erreur', 'Le champ Agence de livraison est obligatoire.', 'error');
      }
    }
