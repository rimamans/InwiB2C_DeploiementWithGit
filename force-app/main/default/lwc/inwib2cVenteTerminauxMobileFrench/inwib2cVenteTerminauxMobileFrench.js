...
import { OMNIDEF } from './inwib2cVenteTerminauxMobileFrench_def.js';
import tmpl from './inwib2cVenteTerminauxMobileFrench.html';
import tmpl_nds from './inwib2cVenteTerminauxMobileFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cVenteTerminauxMobileFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
