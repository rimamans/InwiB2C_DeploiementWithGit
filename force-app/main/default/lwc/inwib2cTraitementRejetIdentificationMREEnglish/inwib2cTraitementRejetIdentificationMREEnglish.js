...
import { OMNIDEF } from './inwib2cTraitementRejetIdentificationMREEnglish_def.js';
import tmpl from './inwib2cTraitementRejetIdentificationMREEnglish.html';
import tmpl_nds from './inwib2cTraitementRejetIdentificationMREEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTraitementRejetIdentificationMREEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
