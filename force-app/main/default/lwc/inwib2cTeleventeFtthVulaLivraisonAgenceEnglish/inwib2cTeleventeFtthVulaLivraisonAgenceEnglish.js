...
import { OMNIDEF } from './inwib2cTeleventeFtthVulaLivraisonAgenceEnglish_def.js';
import tmpl from './inwib2cTeleventeFtthVulaLivraisonAgenceEnglish.html';
import tmpl_nds from './inwib2cTeleventeFtthVulaLivraisonAgenceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cTeleventeFtthVulaLivraisonAgenceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
