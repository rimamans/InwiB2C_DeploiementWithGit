...
import { OMNIDEF } from './inwib2cChargementEnMasseEnglish_def.js';
import tmpl from './inwib2cChargementEnMasseEnglish.html';
import tmpl_nds from './inwib2cChargementEnMasseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cChargementEnMasseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
