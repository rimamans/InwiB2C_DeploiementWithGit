...
import { OMNIDEF } from './inwi360SearchAccountFrench_def.js';
import tmpl from './inwi360SearchAccountFrench.html';
import tmpl_nds from './inwi360SearchAccountFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360SearchAccountFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
