...
import { OMNIDEF } from './inwib2cActivationBoostFTTHEnglish_def.js';
import tmpl from './inwib2cActivationBoostFTTHEnglish.html';
import tmpl_nds from './inwib2cActivationBoostFTTHEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cActivationBoostFTTHEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
