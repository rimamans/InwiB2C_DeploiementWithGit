...
import { OMNIDEF } from './inwib2cRetentionCascadeEnglish_def.js';
import tmpl from './inwib2cRetentionCascadeEnglish.html';
import tmpl_nds from './inwib2cRetentionCascadeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRetentionCascadeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
