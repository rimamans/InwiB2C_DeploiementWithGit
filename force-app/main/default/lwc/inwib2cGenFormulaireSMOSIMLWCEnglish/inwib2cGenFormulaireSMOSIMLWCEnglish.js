...
import { OMNIDEF } from './inwib2cGenFormulaireSMOSIMLWCEnglish_def.js';
import tmpl from './inwib2cGenFormulaireSMOSIMLWCEnglish.html';
import tmpl_nds from './inwib2cGenFormulaireSMOSIMLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGenFormulaireSMOSIMLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
