...
import { OMNIDEF } from './inwib2cInwiB2C_DisplayFilesFrench_def.js';
import tmpl from './inwib2cInwiB2C_DisplayFilesFrench.html';
import tmpl_nds from './inwib2cInwiB2C_DisplayFilesFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cInwiB2C_DisplayFilesFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
