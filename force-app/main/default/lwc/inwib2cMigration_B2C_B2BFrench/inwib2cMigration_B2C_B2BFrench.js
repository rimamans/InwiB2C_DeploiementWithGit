...
import { OMNIDEF } from './inwib2cMigration_B2C_B2BFrench_def.js';
import tmpl from './inwib2cMigration_B2C_B2BFrench.html';
import tmpl_nds from './inwib2cMigration_B2C_B2BFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigration_B2C_B2BFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
