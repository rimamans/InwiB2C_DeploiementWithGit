...
import { OMNIDEF } from './inwi360TransactionsLmEarnFrench_def.js';
import tmpl from './inwi360TransactionsLmEarnFrench.html';
import tmpl_nds from './inwi360TransactionsLmEarnFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360TransactionsLmEarnFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
