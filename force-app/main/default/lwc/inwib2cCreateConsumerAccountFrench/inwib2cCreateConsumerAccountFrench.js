...
import { OMNIDEF } from './inwib2cCreateConsumerAccountFrench_def.js';
import tmpl from './inwib2cCreateConsumerAccountFrench.html';
import tmpl_nds from './inwib2cCreateConsumerAccountFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cCreateConsumerAccountFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
