...
import template from './inwiB2C_SubscriptionDisplayModifLine.html';

export default class InwiB2C_SubscriptionDisplayModifLine extends OmniscriptBaseMixin(NavigationMixin(LightningElement)) {
    constructor() {
        super();
        var accountid = '';
