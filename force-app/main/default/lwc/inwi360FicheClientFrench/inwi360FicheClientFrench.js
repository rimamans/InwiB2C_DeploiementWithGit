...
import { OMNIDEF } from './inwi360FicheClientFrench_def.js';
import tmpl from './inwi360FicheClientFrench.html';
import tmpl_nds from './inwi360FicheClientFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360FicheClientFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
