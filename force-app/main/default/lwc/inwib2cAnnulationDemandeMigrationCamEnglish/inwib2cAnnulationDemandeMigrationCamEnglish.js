...
import { OMNIDEF } from './inwib2cAnnulationDemandeMigrationCamEnglish_def.js';
import tmpl from './inwib2cAnnulationDemandeMigrationCamEnglish.html';
import tmpl_nds from './inwib2cAnnulationDemandeMigrationCamEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cAnnulationDemandeMigrationCamEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
