...
import { OMNIDEF } from './inwib2cModificationTerminalFrench_def.js';
import tmpl from './inwib2cModificationTerminalFrench.html';
import tmpl_nds from './inwib2cModificationTerminalFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cModificationTerminalFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
