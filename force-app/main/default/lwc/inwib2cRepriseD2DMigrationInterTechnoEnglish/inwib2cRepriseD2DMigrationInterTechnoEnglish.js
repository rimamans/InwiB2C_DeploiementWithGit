...
import { OMNIDEF } from './inwib2cRepriseD2DMigrationInterTechnoEnglish_def.js';
import tmpl from './inwib2cRepriseD2DMigrationInterTechnoEnglish.html';
import tmpl_nds from './inwib2cRepriseD2DMigrationInterTechnoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRepriseD2DMigrationInterTechnoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
