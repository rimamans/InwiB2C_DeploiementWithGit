...
import { OMNIDEF } from './inwib2cSearchAMnoHandlerFrench_def.js';
import tmpl from './inwib2cSearchAMnoHandlerFrench.html';
import tmpl_nds from './inwib2cSearchAMnoHandlerFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSearchAMnoHandlerFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
