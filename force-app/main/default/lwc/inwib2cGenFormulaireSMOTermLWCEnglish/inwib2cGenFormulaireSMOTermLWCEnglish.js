...
import { OMNIDEF } from './inwib2cGenFormulaireSMOTermLWCEnglish_def.js';
import tmpl from './inwib2cGenFormulaireSMOTermLWCEnglish.html';
import tmpl_nds from './inwib2cGenFormulaireSMOTermLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cGenFormulaireSMOTermLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
