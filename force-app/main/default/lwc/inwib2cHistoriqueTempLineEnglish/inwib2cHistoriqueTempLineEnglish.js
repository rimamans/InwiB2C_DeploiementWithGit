...
import { OMNIDEF } from './inwib2cHistoriqueTempLineEnglish_def.js';
import tmpl from './inwib2cHistoriqueTempLineEnglish.html';
import tmpl_nds from './inwib2cHistoriqueTempLineEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cHistoriqueTempLineEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
