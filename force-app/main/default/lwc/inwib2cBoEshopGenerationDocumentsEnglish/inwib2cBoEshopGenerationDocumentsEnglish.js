...
import { OMNIDEF } from './inwib2cBoEshopGenerationDocumentsEnglish_def.js';
import tmpl from './inwib2cBoEshopGenerationDocumentsEnglish.html';
import tmpl_nds from './inwib2cBoEshopGenerationDocumentsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cBoEshopGenerationDocumentsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
