...
import { OMNIDEF } from './inwi360TransactionsLmBurnFrench_def.js';
import tmpl from './inwi360TransactionsLmBurnFrench.html';
import tmpl_nds from './inwi360TransactionsLmBurnFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwi360TransactionsLmBurnFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
