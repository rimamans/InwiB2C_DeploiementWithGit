...
import { OMNIDEF } from './inwib2cMigrationIntertechnologieTeleventeEnglish_def.js';
import tmpl from './inwib2cMigrationIntertechnologieTeleventeEnglish.html';
import tmpl_nds from './inwib2cMigrationIntertechnologieTeleventeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cMigrationIntertechnologieTeleventeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
