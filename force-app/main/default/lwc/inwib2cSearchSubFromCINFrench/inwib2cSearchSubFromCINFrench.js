...
import { OMNIDEF } from './inwib2cSearchSubFromCINFrench_def.js';
import tmpl from './inwib2cSearchSubFromCINFrench.html';
import tmpl_nds from './inwib2cSearchSubFromCINFrench_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cSearchSubFromCINFrench extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
