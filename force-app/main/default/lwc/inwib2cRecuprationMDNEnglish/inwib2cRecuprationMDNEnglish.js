...
import { OMNIDEF } from './inwib2cRecuprationMDNEnglish_def.js';
import tmpl from './inwib2cRecuprationMDNEnglish.html';
import tmpl_nds from './inwib2cRecuprationMDNEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwib2cRecuprationMDNEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
