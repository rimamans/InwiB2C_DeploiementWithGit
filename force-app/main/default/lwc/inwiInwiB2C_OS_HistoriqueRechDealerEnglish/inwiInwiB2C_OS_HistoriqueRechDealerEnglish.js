...
import { OMNIDEF } from './inwiInwiB2C_OS_HistoriqueRechDealerEnglish_def.js';
import tmpl from './inwiInwiB2C_OS_HistoriqueRechDealerEnglish.html';
import tmpl_nds from './inwiInwiB2C_OS_HistoriqueRechDealerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class inwiInwiB2C_OS_HistoriqueRechDealerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
